...
public class SpoofSettings {
    ...
    public boolean isVanillaMode() { return spoofBrand && VANILLA.equalsIgnoreCase(customBrand); }
    public boolean isFabricMode() { return spoofBrand && FABRIC.equalsIgnoreCase(customBrand); }
    public boolean isForgeMode() { return spoofBrand && FORGE.equalsIgnoreCase(customBrand); }
